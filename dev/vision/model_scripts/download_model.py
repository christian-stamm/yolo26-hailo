...
def download_and_export(variant:str, output_dir:str):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="/workspaces/yolo26-hailo/res/models", help="Output directory")
