...
#include "visual_perception_interface/msg/b_box_det_list.hpp"
#include "visual_perception_interface/srv/b_box_det.hpp"
...
class DetectorRosNode : public rclcpp::Node {
  public:
        ...
        : rclcpp::Node("yolo26_detector_node")
    {
        ...
        publisher_ = create_publisher<visual_perception_interface::msg::BBoxDetList>(bboxdet_topic, qos);
        ...
        service_ = create_service<visual_perception_interface::srv::BBoxDet>(
            bboxdet_service,                                                                       //
            [this](                                                                                //
                const std::shared_ptr<visual_perception_interface::srv::BBoxDet::Request> request, //
                std::shared_ptr<visual_perception_interface::srv::BBoxDet::Response>      response) {   //
  ...
  private:
    bool process_image(
        const sensor_msgs::msg::Image& image_msg, visual_perception_interface::msg::BBoxDetList& bbox_msg)
    {
        ...
        for (const auto& box : detections) {
            visual_perception_interface::msg::BBoxDet det;
        ...
        std::sort(
            ...
            [](const visual_perception_interface::msg::BBoxDet& lhs,
               const visual_perception_interface::msg::BBoxDet& rhs) { return lhs.confidence < rhs.confidence; });
    ...
    {
        visual_perception_interface::msg::BBoxDetList bbox_msg;
    ...
    rclcpp::Publisher<visual_perception_interface::msg::BBoxDetList>::SharedPtr publisher_;
    rclcpp::Service<visual_perception_interface::srv::BBoxDet>::SharedPtr       service_;
};
