...
class StreamDemoNode : public rclcpp::Node {
 ...
 private:
  ...
  std::shared_ptr<message_filters::Subscriber<visual_perception_interface::msg::BBoxDetList>> bbox_sub_;
  std::shared_ptr<message_filters::TimeSynchronizer<
    sensor_msgs::msg::Image,
    visual_perception_interface::msg::BBoxDetList>> time_sync_;

  // Callbacks
  void frame_callback();
  void plot_frame_callback(
    const sensor_msgs::msg::Image::ConstSharedPtr& img_msg,
    const visual_perception_interface::msg::BBoxDetList::ConstSharedPtr& bbox_msg);
  ...
  void draw_bboxes(
    cv::Mat& frame,
    const visual_perception_interface::msg::BBoxDetList& bbox_msg,
    double scale_x,
